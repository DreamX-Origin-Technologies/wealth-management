  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col font-sans relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none z-0">
        ...
        <div className="absolute top-[5%] left-[-15%] h-[600px] w-[600px] rounded-full bg-violet-200/25 blur-[140px]" />
        <div className="absolute top-[25%] right-[-15%] h-[700px] w-[700px] rounded-full bg-indigo-200/25 blur-[150px]" />
